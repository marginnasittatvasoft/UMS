...
namespace UMS_DataAccess.Data.Migrations
{
    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "City", "Email", "FirstName", "IsDeleted", "LastName", "Password", "Phone", "RoleId", "State", "Street", "UserName" },
                values: new object[,]
                {
                    { 1, "Ahmedabad", "admin@gmail.com", "Admin", false, "Tatvasoft", "Admin@123", "8523698523", 1, "Gujarat", "Rajpath club Road", "Admin123" },
                    { 2, "Ahmedabad", "user@gamil.com", "User", false, "Tatvasoft", "User@123", "9876543210", 2, "Gujarat", "Rajpath Club Road", "User123" }
                });
